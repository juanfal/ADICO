...
public class VCO2 extends JPanel {
    ...
    private int modoDecide = 1; //1=Con boton Decide, 2=Mensaje en estado, 3=Mensaje en ventanita, 4=Mensaje incrustado en VCO, 5=Mensaje incrustado siempre visible
...
//ALUIS:    //Color de fondo 2 del panel
    private Color colorFondo2=new Color(180,180,180);
//ALUIS:    //Color de la letra 2 del panel
    private Color colorLetra2=new Color(220,220,255);
    ...
    private Color colorLetraBotonInactivo = new Color(180,180,180); //Color.GRAY
    //Color de la letra del decide incrustado
    private Color colorLabelDecide = new Color(20,20,20); // new Color(10,10,10);
    private Color colorLabelDecide2 = new Color(200,200,200); // new Color(10,10,10);
    
    //FUENTES
//ALUIS:    
    //Fuente de los botones (de tipo Cancelar... pero no de los pasos/opciones)
...
//ALUIS:        
        boton[idpanel][l]=new JButton("<html><font size=3>" + prefijo + ".</font> "+"<font size=4>" + titulo + "</font> "+"</html>"); 
        //al ser codigo html, si no cabe en una linea ocupa las necesarias
...
//ALUIS:    
    public void defineBotonReturn(int idpanel, ActionListener subrutina, String texto) {
        defineBoton(idpanel, texto, 'r');
        int l = boton[idpanel].length;
        boton[idpanel][l-1].addActionListener(new ReturnActionListener(idpanel, 0));
        if (subrutina!=null) { boton[idpanel][l-1].addActionListener(subrutina); }
    }
    ...
    public void defineBotonCancelar(int idpanel, ActionListener subrutina) {
        defineBotonCancelarDisableIf("",idpanel, subrutina, null, null);     // ALUIS  "" 
    }

// ALUIS    
public void defineBotonCancelar(String mensaje, int idpanel, ActionListener subrutina) {
        defineBotonCancelarDisableIf(mensaje, idpanel, subrutina, null, null);
    }
    ...
    public void defineBotonCancelarDisableIf(int idpanel, String condicionDI, Integer valorDI) {
            defineBotonCancelarDisableIf("", idpanel, null, condicionDI, valorDI);  // ALUIS  ""  

    }

// ALUIS    
public void defineBotonCancelarDisableIf(String mensaje, int idpanel, String condicionDI, Integer valorDI) {
            defineBotonCancelarDisableIf(mensaje, idpanel, null, condicionDI, valorDI);
    }
     ...
     * @param valorDI Valor que ha de tener condicionDI para desactivar el bot&oacute;n
     */
    public void defineBotonCancelarDisableIf(String mensaje, int idpanel, ActionListener subrutina, String condicionDI, Integer valorDI) {
        //crear contenedor
        ...
        //crear boton
        bCancelable[idpanel] = new JButton("Cancelar"+mensaje);
...
//ALUIS:
                ...
                boton[idpanel][l-1].getText().substring(0,boton[idpanel][l-1].getText().length()-7)+
                        "<br>SI => repita paso "+ go + "<br>NO => pinche paso " + (l+1)+
                        "<br>&nbsp;</html>");
                labelDecideIncrustado.setForeground(colorLabelDecide2);
    ...
    public String camino() {
        String camino = "<html>Objetivo actual:   "; // <font color=#909090>";
        
        //Iteramos sobre la pila
        for (ElementoPilaVCO epv : pilaVCO) {
            camino = camino +  "<font color=#909090>" + titulos[epv.numPanel].getText() + " >> </font>";
            //camino = camino +  "<font color=#909090>" + titulos[epv.numPanel].getText() + "</font> > ";
        }
        // camino = camino + "<u>" + titulos[idPanelActual].getText()+"</u></html>";
        camino = camino + "<b>" + titulos[idPanelActual].getText()+ "</b></html>";
